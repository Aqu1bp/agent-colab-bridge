...
async function runMcp() {
  if (!existsSync(serverPath)) {
    process.stderr.write(
      "codex-colab-bridge MCP server build output is missing from this package. Reinstall the package or run `npm run build` from a source checkout.\n",
    );
    process.exit(1);
  }
...
function helpText() {
  return `Usage: codex-colab-bridge <command>
